...
== @LEDアレイ の電子部品 ( LEDアレイ C-551SRD) を次のような点から調べなさい。
...
@7セグメントLED各部の名称 は、7セグメントLEDの各部の名称を示している。
...
@LEDアレイグラフ は、電圧が増加すると電流値が増加する。グラフの形としては指数関数的に増加している。
...
== @DCモーター の電子部品 ( DCモーター FA-130RA) を次のような点から調べなさい。
...
@DCモーターグラフ は、電圧が増加すると回転数が増加する。グラフの形としては線形的に増加している。
...
== @トランジスタ の電子部品 ( トランジスタ 2SC2120Y) を次のような点から調べなさい。
...
@ダイオードグラフ は、電圧が増加すると電流値が増加する。グラフの形としては指数関数的に増加している。
立ち上がり電圧は0.4Vである。
